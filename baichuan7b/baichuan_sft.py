...
from _common import *
# tb_dir = os.path.join('/DATA/zqfang/modelscope/modelscope/examples/pytorch/llm_agent/runs/baichuan7B/v29-20230816-153524', 'tensorboard_output')
tb_dir = os.path.join('/DATA/zqfang/modelscope/modelscope/examples/pytorch/llm_agent/runs/baichuan7B/v30-20230820-232412', 'tensorboard_output')
...
# savepath = "/DATA/zqfang/modelscope/modelscope/examples/pytorch/llm_agent/runs/baichuan7B/v29-20230816-153524"
savepath = "/DATA/zqfang/modelscope/modelscope/examples/pytorch/llm_agent/runs/baichuan7B/v30-20230820-232412"
